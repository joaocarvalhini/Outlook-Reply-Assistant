...
flowchart TB
    subgraph G["GRÁTIS — sem chamadas ao modelo"]
        T1["<b>test_assistente.py</b><br/>296 testes unitários<br/><i>o código faz o que diz?</i><br/>~1,7 s"]
...
**Implemented** — 296 testes, `unittest` da biblioteca padrão, **zero dependências de teste**.
