...
flowchart TB
    ...
    subgraph P["PAGO — chamadas reais ao modelo"]
        T5["<b>eval.py</b><br/>87 casos etiquetados<br/><i>o modelo decide bem?</i>"]
...
87 casos etiquetados, com métricas assimétricas. Tem documento próprio:
...
flowchart TD
    ...
    D -->|passa| E["eval.py completo<br/><i>87 casos, uma vez no fim</i>"]
    D -->|falha| A
...
> Correr os 87 casos a cada iteração é desperdício. O `eval/subset.json` tem 23 casos
