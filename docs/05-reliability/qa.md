...
flowchart TB
    subgraph G["GRÁTIS — sem chamadas ao modelo"]
        T1["<b>test_assistente.py</b><br/>291 testes unitários<br/><i>o código faz o que diz?</i><br/>~1,7 s"]
...
**Implemented** — 291 testes, `unittest` da biblioteca padrão, **zero dependências de teste**.
