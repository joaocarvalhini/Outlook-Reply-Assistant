...
COLUNAS_A_PURGAR = (
    ...
    "corpo",
    "por_responder",
    # Texto da nota interna (motivo, categoria, número de encomenda e, num
    # parcial, o que ficou por tratar) -- mesmo tipo de conteúdo que corpo/
    # por_responder, mesma purga. nota_interna_id fica de fora, tal como
    # rascunho_id: é um id opaco, não texto pessoal.
    "nota_interna_texto",
